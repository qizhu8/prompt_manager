...
class TestPromptModeSelector(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.chat_jinja = ChatJinja(vars_in_data_dict={"Data": "Data", "Content": "Content"}, version="v1")
        self.completion_jinja = CompletionJinja(vars_in_data_dict={"Data": "Data", "Content": "Content"}, version="v1")
        warnings.simplefilter('ignore', category=UserWarning)

    def test_completion_prompt_generation(self):
        # Test the prompt variable population
        data = {"Data": "test_data", "Content": "test_content"}
        prompt_string = self.completion_jinja.generate_prompt(
            data=data, prompt_mode=PromptMode.COMPLETION)
        expected_prompt = """This is a test prompt for the completion API.\n\nInput: "test_data"\n#Crawled Landing Page: "test_content"\n#Result\n"""
    ...
    def test_chat_prompt_generation(self):
        ...
        prompt_string = self.chat_jinja.generate_prompt(
            data=data, prompt_mode=PromptMode.CHAT)
        expected_prompt = (
    ...
    def test_completion_prompt_with_chat_mode(self):
        # Test the prompt variable population
        data = {"Data": "test_data", "Content": "test_content"}
        prompt_string = self.completion_jinja.generate_prompt(
            data=data, prompt_mode=PromptMode.CHAT)
        ...
        expected_prompt = (
            ('user', 'This is a test prompt for the completion API.\n\nInput: "test_data"\n#Crawled Landing Page: "test_content"\n#Result\n'),
